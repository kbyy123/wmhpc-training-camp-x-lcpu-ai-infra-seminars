  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 16; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(A_desc, mbarrier[(k % 3)], (&(((half_t*)A_shared)[((k % 3) * 8192)])), (k * 64), (((int)blockIdx.y) * 128));
        mbarrier[(k % 3)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, mbarrier[(k % 3)], (&(((half_t*)B_shared)[((k % 3) * 8192)])), (((int)blockIdx.x) * 128), (k * 64));
        tl::tma_load(B_desc, mbarrier[(k % 3)], (&(((half_t*)B_shared)[(((k % 3) * 8192) + 4096)])), ((((int)blockIdx.x) * 128) + 64), (k * 64));
      }
    }
  } else {
      ...
      mbarrier[(k_1 % 3)].wait(((k_1 % 6) / 3));
      {
        ...
        for (int ki = 0; ki < 4; ++ki) {
          ...
          for (int i_1 = 0; i_1 < 4; ++i_1) {
            tl::ptx_ldmatrix_x4((&(((half_t*)A_shared)[((((((k_1 % 3) * 8192) + (((((int)threadIdx.x) & 63) >> 5) * 4096)) + (i_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local[(i_1 * 8)])));
          }
          #pragma unroll
          for (int i_2 = 0; i_2 < 4; ++i_2) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[((((((k_1 % 3) * 8192) + (((((int)threadIdx.x) & 127) >> 6) * 4096)) + (ki * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_2 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local[(i_2 * 8)])));
          }
